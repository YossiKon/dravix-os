                           ...
                           public Parented<FTServo>
{
 ...
 public:
  void control(float value) override {
    ...
    // dravix: was a blocking delay(travel + 100 ms) + torque release here — scheduled instead
    if (speed <= 0) speed = 500;
    this->parent_->release_torque_after(abs(target_pos - current_pos) * 1000 / speed + 100);
